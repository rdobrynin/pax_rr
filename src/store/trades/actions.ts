...
export const updateTradeChat = (data: ITrade) => action(TradesActionTypes.UPDATE_TRADE_CHAT, data)
export const addMessageTradeChat = (data: ITrade) => action(TradesActionTypes.ADD_MESSAGE_TRADE_CHAT, data)
